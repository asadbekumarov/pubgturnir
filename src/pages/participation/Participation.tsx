...
//     return (
//         <div className="bg-[#000102] py-10 px-5">
...
//                             <div
//                                 key={app.id}
//                                 className="bg-black/40 p-6 rounded-xl border border-white/10 hover:border-[#f3aa01] transition"
//                             >
//                                 {/* Turnir nomi */}
...
//                                     {new Date(app.appliedAt).toLocaleString("uz-UZ")}
//                                 </p>
//                             </div>
//                         ))}
//                     </div>
...
export default function ApplicationList() {
    ...
    if (error) {
        // React Query error obyektini stringga aylantiramiz
        const errorMessage =
                            ...
                            >
                                ...
                                <div className="space-y-3 text-sm text-gray-300">
                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span>
                                            Ishtirokchi ID:{" "}
                                            <span className="font-mono">{app.user.slice(0, 8)}</span>
                                        </span>
                                    </div>
