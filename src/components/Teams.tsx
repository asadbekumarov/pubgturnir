...
const Teams = () => {
    ...
    const getTeamsByCategory = () => {
        switch (activeCategory) {
            case 'top': return topTeams;
            case 'new': return newTeams;
            case 'local': return localTeams;
            default: return topTeams;
        }
    };
    ...
    const getStatusIcon = (status) => {
        switch (status) {
            ...
            case 'RISING': return <Zap className="h-4 w-4" />;
            case 'ROOKIE': return <Shield className="h-4 w-4" />;
